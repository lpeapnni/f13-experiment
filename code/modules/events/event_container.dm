...
/datum/event_container/mundane
	...
	available_events = list(
		...
		// new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Economic News",					/datum/event/location_event/mundane_news,		300), // F13 REMOVAL - NO BACKGROUNDS
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Lost Carp",						/datum/event/carp_migration, 		20, 	list(ASSIGNMENT_SECURITY = 10), 1),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Money Hacker",					/datum/event/money_hacker, 			0, 		list(ASSIGNMENT_ANY = 4), 1, 10, 25),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Money Lotto",					/datum/event/money_lotto, 			0, 		list(ASSIGNMENT_ANY = 1), 1, 5, 15),
		// new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Mundane News", 					/datum/event/location_event, 			300), // F13 REMOVAL - NO BACKGROUNDS
